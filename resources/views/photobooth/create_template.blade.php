                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">Tambahkan template photobooth untuk event Anda</p>
                        </div>
                    </div>
                </div>

                <!-- Form -->
                <form action="{{ route('photobooth.template.store') }}" method="POST" enctype="multipart/form-data"
