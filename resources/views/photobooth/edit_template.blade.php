                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">Perbarui detail template photobooth Anda</p>
                        </div>
                    </div>
                </div>

                <!-- Form -->
                <form action="{{ route('photobooth.template.update') }}" method="POST" enctype="multipart/form-data"
